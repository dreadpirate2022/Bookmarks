...
def register(request):
    if request.method == 'POST':
        ...
        if user_form.is_valid():
            # Create a new user object but avoid saving it in database
...
def user_list(request):
    ...
    return render(request, 'account/user/list.xhtml', context)
...
def user_detail(request, username):
    ...
    return render(request, 'account/user/detail.xhtml', context)
