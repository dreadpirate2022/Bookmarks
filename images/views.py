...
def image_detail(request, id, slug):
    ...
    return render(request, 'images/image/detail.xhtml', context)
...
def image_list(request):
    ...
    if images_only:
        return render(request, 'images/image/list_images.xhtml', {'section':'images', 'images':images})

    return render(request, 'images/image/list.xhtml', {'section':'images', 'images':images})
